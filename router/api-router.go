...
func SetApiRouter(router *gin.Engine) {
        ...
        apiRouter.Use(middleware.GlobalAPIRateLimit())
        {
                ...
                apiRouter.POST("/freekassa/notify", controller.FreeKassaNotify)
                apiRouter.GET("/freekassa/notify", controller.FreeKassaNotify)
                ...
                optionRoute.Use(middleware.RootAuth())
                {
                        ...
                        optionRoute.GET("/cbr-rate", controller.GetCBRRateHandler)
                        optionRoute.POST("/cbr-rate/apply", controller.ApplyCBRRateHandler)
