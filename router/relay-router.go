...
func SetRelayRouter(router *gin.Engine) {
	...
	guestRouter := router.Group("/v1/guest", middleware.TokenAuth())
	guestRouter.GET("/catalog", controller.GuestCatalog)
	guestRouter.GET("/receipts/:id", controller.GuestReceipt)
