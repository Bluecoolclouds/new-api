...
var defaultModelPrice = map[string]float64{
	...
	"ByteDance/Seedance-2.0":         0.115,
	"ByteDance/Seedance-1.0-pro":     0.115,
	"ByteDance/Seedance-1.0-lite":    0.06,
	"Wan-AI/wan2.7-t2v":              0.20,
	"Wan-AI/wan2.7-i2v":              0.20,
	"Wan-AI/wan2.7-r2v":              0.20,
	"gpt-4o-mini-tts":                0.3,
