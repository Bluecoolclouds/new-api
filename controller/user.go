...
// VerifyToken accepts a relay sk-... token and returns basic user info.
// Designed for third-party services (e.g. Odysseus) to verify APINET users.
...
func GetSelf(c *gin.Context) {
        ...
        responseData := map[string]interface{}{
			...
			"today_quota":       service.GetTodayQuotaForUserSafe(id),
        }
