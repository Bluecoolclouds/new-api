...
func isFreeKassaTopUpEnabled() bool {
        if !isPaymentComplianceConfirmed() {
                return false
        }
        return strings.TrimSpace(setting.FreeKassaMerchantId) != "" &&
                strings.TrimSpace(setting.FreeKassaSecretWord1) != "" &&
                strings.TrimSpace(setting.FreeKassaSecretWord2) != ""
}

func isFreeKassaWebhookEnabled() bool {
