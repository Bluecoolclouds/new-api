...
const defaultBillingSettings: BillingSettings = {
  ...
  FreeKassaMerchantId: '',
  FreeKassaSecretWord1: '',
  FreeKassaSecretWord2: '',
  FreeKassaCurrency: 'RUB',
  FreeKassaUnitPrice: 90,
  FreeKassaMinTopUp: 1,
  FreeKassaReturnURL: '',
  FreeKassaPaymentSystemId: '44',
  FreeKassaCardPaymentSystemId: '',
  FreeKassaCryptoPaymentSystemId: '',
  FreeKassaFallbackEmail: '',
  FreeKassaCBRMarkup: 0,
  FreeKassaCBRAutoSync: false,
  FreeKassaEnableSBP: true,
  ...
  'checkin_setting.telegram_channel_id': '',
}
