...
| 额度 | Кредиты | Quota/Credits | Доступные кредиты для пользователя |
...
| Китайский | Русский | Английский | Описание |
|-----------|--------|-----------|----------|
| 充值 | Пополнение | Top Up | Добавление кредитов на аккаунт |
| 兑换码 | Код купона | Redemption Code | Код, который можно обменять на кредиты |
...
**Кредиты (Quota/Credits)**

- Доступные кредиты пользователя для использования услуг
- Стандартный перевод: "кредиты" во всех формах
